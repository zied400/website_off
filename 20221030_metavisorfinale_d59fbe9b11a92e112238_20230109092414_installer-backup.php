...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221030_metavisorfinale_d59fbe9b11a92e112238_20230109092414_archive.zip';
        const ARCHIVE_SIZE       = '101667053';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'd59fbe9-09092414';
        const SECONDARY_PACKAGE_HASH = '77f4175-09092414';
        const VERSION            = '1.5.0';
